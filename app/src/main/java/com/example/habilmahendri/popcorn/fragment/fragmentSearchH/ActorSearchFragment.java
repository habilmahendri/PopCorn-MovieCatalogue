...
public class ActorSearchFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_actor_search, container, false);
    ...
    public void getSearch(String hasil) {
        ...
        if (!isEmptyFields) {
            apicall = apiClient.getApiCall().getSearchPeople(hasil);
            apicall.enqueue(new Callback<JSONResponse>() {
                ...
                public void onResponse(Call<JSONResponse> call, Response<JSONResponse> response) {
                    ...
                    for (int i = 0; i < data.size(); i++) {
                        ...
                        Log.i(TAG, "people  peo: " + p.getName());
                    }
                    initView();
